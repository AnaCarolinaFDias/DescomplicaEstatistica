...
# Gerando microdados da PNAD Continua pelo metodo manual
...
# Realizando modelo linear generalizado da renda em relacao a sexo e idade
summary(svyglm(formula=VD4019 ~ V2007 + V2009, design=dadosPNADc))
